...
<body class="bg-white text-gray-900 antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="mobile-menu" class="hidden md:hidden pb-4 border-t border-slate-800 mt-0 bg-slate-900">
                <div class="flex flex-col gap-3 pt-3 px-4">
                    ...
                    <a href="#categories" class="text-slate-300 hover:text-white text-sm py-1">Categories</a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 w-full">
            <div class="relative grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                ...
                <div class="relative text-left max-w-2xl px-4 sm:px-0 fade-in">
                    <span class="inline-flex items-center gap-2 bg-blue-50 text-blue-700 border border-blue-100 px-3 py-1.5 rounded-full text-xs font-semibold mb-6">
                ...
                <div class="relative hidden lg:block fade-in-delay-1 w-full h-[600px]">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center pointer-events-none" aria-hidden="true">
                        <div class="absolute w-[450px] h-[450px] bg-blue-200 opacity-40 rounded-full blur-3xl -translate-x-10 -translate-y-5"></div>
                        <div class="absolute w-[350px] h-[350px] bg-indigo-200 opacity-30 rounded-full blur-2xl translate-x-16 translate-y-16"></div>
                    </div>

                    {{-- Books Container --}}
                    <div class="relative w-full h-full flex items-center justify-center flex-col perspective-[1000px]">
                        {{-- Book 1: Left Background --}}
                        <div class="absolute w-56 aspect-[3/4] rounded-xl shadow-2xl overflow-hidden z-10 transform transition-transform duration-500 hover:-rotate-12 -rotate-[8deg] -translate-x-[110px] translate-y-[30px]" style="box-shadow: -15px 15px 35px rgba(0,0,0,0.2);">
                            @if(isset($featuredBooks[1]) && $featuredBooks[1]->cover_image)
                                <img src="{{ asset('storage/' . $featuredBooks[1]->cover_image) }}" alt="Book 1" class="w-full h-full object-cover relative z-0">
                            @else
                                <div class="w-full h-full bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center relative z-0">
                                    <span class="text-blue-300 font-bold text-center px-4">{{ $featuredBooks[1]->title ?? 'Book 1' }}</span>
                                </div>
                            @endif
                        ...
                        <div class="absolute w-56 aspect-[3/4] rounded-xl shadow-2xl overflow-hidden z-10 transform transition-transform duration-500 hover:rotate-12 rotate-[10deg] translate-x-[120px] translate-y-[45px]" style="box-shadow: 15px 15px 35px rgba(0,0,0,0.2);">
                            @if(isset($featuredBooks[2]) && $featuredBooks[2]->cover_image)
                                <img src="{{ asset('storage/' . $featuredBooks[2]->cover_image) }}" alt="Book 2" class="w-full h-full object-cover relative z-0">
                            @else
                                <div class="w-full h-full bg-gradient-to-br from-sky-100 to-blue-200 flex items-center justify-center relative z-0">
                                    <span class="text-blue-400 font-bold text-center px-4">{{ $featuredBooks[2]->title ?? 'Book 2' }}</span>
                                </div>
                            @endif
                            <div class="absolute inset-0 border border-white/20 rounded-xl z-20"></div>
                        </div>
                        ...
                        <div class="absolute w-64 aspect-[3/4] rounded-xl shadow-[0_30px_60px_-15px_rgba(0,0,0,0.35)] overflow-hidden z-20 transform transition-transform duration-500 hover:-translate-y-3 -translate-y-4">
                            @if(isset($featuredBooks[0]) && $featuredBooks[0]->cover_image)
                                <img src="{{ asset('storage/' . $featuredBooks[0]->cover_image) }}" alt="Book 3" class="w-full h-full object-cover relative z-0">
                            @else
                                <div class="w-full h-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center relative z-0">
                                    <span class="text-white font-bold text-center px-4 text-xl">{{ $featuredBooks[0]->title ?? 'Featured Book' }}</span>
                                </div>
                            @endif
                            <div class="absolute inset-x-0 top-0 h-full bg-gradient-to-t from-black/20 to-transparent z-10"></div>
    ...
    ============================================================ --}}
    <section id="books" class="bg-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
