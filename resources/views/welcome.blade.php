...
<body class="bg-white text-gray-900 antialiased">
    ...
    METRICS BAR
    ============================================================ --}}
    <section class="bg-slate-50 py-16 w-full">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                {{-- Card 1: Ebooks --}}
                <div class="bg-white rounded-2xl shadow-md border border-slate-200 p-8 text-center transform transition-transform duration-300 hover:-translate-y-2">
                    <div class="bg-indigo-50 text-indigo-600 w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-4">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                    </div>
                    <div class="text-4xl font-extrabold text-gray-900 mb-2">10K+</div>
                    <div class="text-sm font-medium text-gray-500 uppercase tracking-wide">Ebooks</div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-md border border-slate-200 p-8 text-center transform transition-transform duration-300 hover:-translate-y-2">
                    ...
                    <div class="text-4xl font-extrabold text-gray-900 mb-2">500+</div>
                    <div class="text-sm font-medium text-gray-500 uppercase tracking-wide">Authors</div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-md border border-slate-200 p-8 text-center transform transition-transform duration-300 hover:-translate-y-2">
                    ...
                    <div class="text-4xl font-extrabold text-gray-900 mb-2">50+</div>
                    <div class="text-sm font-medium text-gray-500 uppercase tracking-wide">Categories</div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-md border border-slate-200 p-8 text-center transform transition-transform duration-300 hover:-translate-y-2">
                    ...
                    <div class="text-4xl font-extrabold text-gray-900 mb-2">24/7</div>
                    <div class="text-sm font-medium text-gray-500 uppercase tracking-wide">Access</div>
                </div>
            </div>
        </div>
    </section>
