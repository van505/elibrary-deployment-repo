    ...
    <aside class="w-64 bg-slate-800 flex flex-col flex-shrink-0 h-screen overflow-y-auto">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1">
            ...
            $links = [
                ...
                ['route' => 'member.borrowings.index',    'label' => 'My Borrowings',   'icon' => 'M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4'],
                ['route' => 'member.reservations.index',  'label' => 'My Reservations', 'icon' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z'],
