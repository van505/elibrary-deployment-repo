...
<body class="bg-gray-50 flex h-screen overflow-hidden">
    ...
    <aside id="sidebar"
        ...
        <div class="flex items-center gap-3 px-6 py-5 border-b border-slate-700">
            ...
            <span class="text-xs text-blue-400 font-medium ml-auto">Admin</span>
        </div>
        ...
        <div class="px-4 py-4 border-t border-slate-700 flex items-center justify-between">
            <div class="flex items-center gap-3 min-w-0">
                <div class="w-8 h-8 flex-shrink-0 bg-blue-600 rounded-full flex items-center justify-center text-white text-xs font-bold">
    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden min-w-0">
        ...
        <header class="bg-white border-b border-gray-200 px-4 md:px-6 py-4 flex items-center justify-between flex-shrink-0">
            ...
            <div class="flex items-center gap-4">
                {{-- Notifications Bell --}}
                <a href="#" class="relative p-2 text-gray-500 hover:text-blue-600 transition-colors" title="Notifications">
                ...
                <div class="flex items-center gap-2 border-l border-gray-200 pl-4">
                    <span class="hidden sm:block text-sm text-gray-600 font-medium">{{ auth()->user()->display_name }}</span>
                    <div class="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center text-white text-xs font-bold shadow-sm">
                        {{ strtoupper(substr(auth()->user()->first_name ?? auth()->user()->email ?? 'A', 0, 1)) }}
                    </div>
                </div>
            </div>
